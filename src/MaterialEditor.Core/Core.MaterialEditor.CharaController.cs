...
namespace KK_Plugins.MaterialEditor
{
    ...
    public class MaterialEditorCharaController : CharaCustomFunctionController
    {
        ...
        internal void ChangeCustomClothesEvent(int slot)
        {
            ...
            // Don't close ME here — the ChangeCustomClothes hook's UpdateUIClothes call
            // (or the maker button) will repopulate it with the new clothing data.
            // Closing here causes a flicker / premature close during slot swaps in maker.
        ...
        internal void ChangeHairEvent(int slot)
        {
            ...
            // Don't close ME here — the ChangeHairAsync hook's RefreshHairDelayed coroutine
            // will repopulate it with the new hair data after loading completes.
            // Closing here causes ME to shut during hair slot swaps in maker.
